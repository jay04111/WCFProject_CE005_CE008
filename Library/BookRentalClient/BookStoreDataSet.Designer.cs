...
namespace BookRentalClient {
    ...
    public partial class BookStoreDataSet : global::System.Data.DataSet {
        ...
        public partial class BooksDataTable : global::System.Data.TypedTableBase<BooksRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public BooksRow AddBooksRow(int bid, string bname, int stock, int price) {
...
namespace BookRentalClient.BookStoreDataSetTableAdapters {
    ...
    public partial class BooksTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Books] WHERE (([bid] = @Original_bid) AND ((@IsNull_bname = 1 AND [bname] IS NULL) OR ([bname] = @Original_bname)) AND ((@IsNull_stock = 1 AND [stock] IS NULL) OR ([stock] = @Original_stock)) AND ((@IsNull_price = 1 AND [price] IS NULL) OR ([price] = @Original_price)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Books] ([bid], [bname], [stock], [price]) VALUES (@bid, @bname" +
                ", @stock, @price);\r\nSELECT bid, bname, stock, price FROM Books WHERE (bid = @bid" +
                ")";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Books] SET [bid] = @bid, [bname] = @bname, [stock] = @stock, [price] = @price WHERE (([bid] = @Original_bid) AND ((@IsNull_bname = 1 AND [bname] IS NULL) OR ([bname] = @Original_bname)) AND ((@IsNull_stock = 1 AND [stock] IS NULL) OR ([stock] = @Original_stock)) AND ((@IsNull_price = 1 AND [price] IS NULL) OR ([price] = @Original_price)));
SELECT bid, bname, stock, price FROM Books WHERE (bid = @bid)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::BookRentalClient.Properties.Settings.Default.BookStoreConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT bid, bname, stock, price FROM dbo.Books";
        ...
        public virtual int Delete(int Original_bid, string Original_bname, global::System.Nullable<int> Original_stock, global::System.Nullable<int> Original_price) {
        ...
        public virtual int Insert(int bid, string bname, global::System.Nullable<int> stock, global::System.Nullable<int> price) {
        ...
        public virtual int Update(int bid, string bname, global::System.Nullable<int> stock, global::System.Nullable<int> price, int Original_bid, string Original_bname, global::System.Nullable<int> Original_stock, global::System.Nullable<int> Original_price) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string bname, global::System.Nullable<int> stock, global::System.Nullable<int> price, int Original_bid, string Original_bname, global::System.Nullable<int> Original_stock, global::System.Nullable<int> Original_price) {
            return this.Update(Original_bid, bname, stock, price, Original_bid, Original_bname, Original_stock, Original_price);
        }
    }
